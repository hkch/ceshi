(function(window, undefined) {
	...
	window.open = function(sURL, sName, sFeatures, bReplace) {
		...
		} else if ('?arg=10060470&style=5&kflist=off&kf=service@avtechcn.cn,office@avtechcn.cn,training@avtechcn.cn,dandanzhu@avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&lytype=0&referer={hz6d_referer}{hz6d_keyword}&tpl=crystal_blue' != '') {
			var _zdyurl = '?arg=10060470&style=5&kflist=off&kf=service@avtechcn.cn,office@avtechcn.cn,training@avtechcn.cn,dandanzhu@avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&lytype=0&referer={hz6d_referer}{hz6d_keyword}&tpl=crystal_blue';
	...
	if (!$53.getCookie('53gid0')){
		$53.setCookie('53gid0','50443799210',{
	...
	if (!$53.getCookie('53gid1')){
		$53.setCookie('53gid1','50443799210',{
			expires:86400
		});
		$53.data('is_rv',0);
	} else if($53.getCookie('53gid2')){
	...
	if(!$53.getCookie('53gid2')) {
		$53.setCookie('53gid2','50443799210',{
	...
	$53.data('visit_uuid','3f75292fe7f0c4ef01803286d446d206');
	$53.data('in_time','2015-01-07 12:49:23');
	$53.data('company_id','72060470');
	...
	var hz6d_from_page = $53.getCookie("53kf_72060470_keyword"),
			kf_72060470_keyword_ok = $53.getCookie("kf_72060470_keyword_ok");
	if (kf_72060470_keyword_ok != 1)
	{
		hz6d_from_page = document.referrer;
	}
	$53.data('page_referer',hz6d_from_page);

	$53.setCookie("53kf_72060470_keyword",hz6d_from_page);
	$53.setCookie("kf_72060470_keyword_ok",1);
	...
	function hasdoctype()
  {
	...
	function setIsinvited()
	{
		try
		{
			...
			if (acc_autotype == 3)
			{
				document.cookie = "onliner_zdfq72060470=" + onliner_zdfq;
			}
		}
		catch (e)
		{}
	}
	var onliner_zdfq = $53.getCookie("onliner_zdfq72060470"); // onliner_zdfq: 0.初始值 2.点击接受 3.点击拒绝 
	if (onliner_zdfq == "")
	{
		onliner_zdfq = 0;
		document.cookie = "onliner_zdfq72060470=" + onliner_zdfq;
	...
	// 加载ivt.php，即中间的接受邀请层 
	if (!$53("ivt_script") && !0){
		//document.write("<scr"+"ipt src='http://www10.53kf.com/kf_ivt.php?arg=10060470&test_do=&style=5&isonline=1&kfonline=1&lang=cn&resize=yes&charset=gbk&kflist=off&kf=service@avtechcn.cn,office@avtechcn.cn,training@avtechcn.cn,dandanzhu@avtechcn.cn&zdkf_type=1"+ hz6d_referer + hz6d_from_page_new + "&lytype=0&tpl_name=crystal_blue&tpl_width=703&tpl_height=473' type='text/javascript' id='ivt_script' charset='utf-8'></scr"+"ipt>");
		$53.createScript('ivt_script', 'http://www10.53kf.com/kf_ivt.php?arg=10060470&test_do=&style=5&isonline=1&kfonline=1&lang=cn&resize=yes&charset=gbk&kflist=off&kf=service@avtechcn.cn,office@avtechcn.cn,training@avtechcn.cn,dandanzhu@avtechcn.cn&zdkf_type=1'+ hz6d_referer + hz6d_from_page_new + '&lytype=0&tpl_name=crystal_blue&tpl_width=703&tpl_height=473&' + Math.random());
	}	  
	  ...
	  for (var i = 0; i < script_total.length; i++)
	  {
	      ...
	      for (var i = 0; i < element_arrs.length; i++)
	      {
	        ...
	        else
	        {
						switch (tmp_e_type)
	          {
	            ...
	            case 'etel': click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=72060470&style_id=106097304\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
	            case 'qq':
	      ...
	      var divs_str = '';
			...
			//end 
						...
						function _createIconDivMain()
						{
							...
							if (this.config["isonline"] == 1)
							{
								if('1')
								{
									var onval_str = '<div id="KFLOGO" style="width: 102px; height: 255px; position: relative; z-index: 10000; cursor: pointer;" minheight="100" minwidth="100" maxheight="400" maxwidth="400" class="Lelem" operating="null"><div operating="null" style="display: block; cursor: pointer; position: absolute; top: 0px; left: 4px; z-index: 10003; width: 98px; height: 97px;" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_12.png" style="width: 98px; height: 97px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 105px; left: 10px; z-index: 10004; width: 82px; height: 31px;" operating="KF" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 82px; height: 31px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 139px; left: 10px; z-index: 10005; width: 83px; height: 31px;" operating="KF" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 83px; height: 31px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 208px; left: 10px; z-index: 10006; width: 83px; height: 31px;" operating="QQ|343788668" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 83px; height: 31px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 173px; left: 10px; z-index: 10007; width: 83px; height: 31px;" operating="KF" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 83px; height: 31px;"></div><div style="display: block; cursor: default; position: absolute; top: 113px; left: 18px; z-index: 10008; width: 16px; height: 16px;" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_2.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: default; position: absolute; top: 147px; left: 17px; z-index: 10009; width: 16px; height: 16px;" type="img" class="Lelem" operating=" "><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_2.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: default; position: absolute; top: 180px; left: 17px; z-index: 10010; width: 16px; height: 16px;" type="img" class="Lelem" operating=" "><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_2.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: default; position: absolute; top: 216px; left: 17px; z-index: 10011; width: 16px; height: 16px;" type="img" class="Lelem" operating=" "><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_1.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 112px; left: 45px; z-index: 10013; width: 31px; height: 17px;" type="text" class="Lelem" operating="KF"><span style="vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;" iseditable="1">客服1</span></div><div style="display: block; cursor: pointer; position: absolute; top: 146px; left: 45px; z-index: 10014; width: 37px; height: 17px;" type="text" class="Lelem" operating="KF"><span style="vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;" iseditable="1">客服2</span></div><div style="display: block; cursor: pointer; position: absolute; top: 179px; left: 45px; z-index: 10015; width: 41px; height: 17px;" type="text" class="Lelem" operating="KF"><span style="vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;" iseditable="1">客服3</span></div><div style="display: block; cursor: pointer; position: absolute; top: 214px; left: 41px; z-index: 10016; width: 47px; height: 17px;" type="text" class="Lelem" operating="QQ|343788668"><span style="vertical-align: top; font-size: 11.9px; line-height: 17px;" iseditable="1">QQ客服</span></div><div operating="null" class="Lelem" type="img" style="display: block; cursor: pointer; position: absolute; top: 33px; left: 3px; z-index: 10001; width: 97px; height: 217px;"><img style="width: 97px; height: 217px;" src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg/commonbg_11.png"></div></div>';
									...
									html += hz6d_clicurl(this.config["isonline"],'<div id="KFLOGO" style="width: 102px; height: 255px; position: relative; z-index: 10000; cursor: pointer;" minheight="100" minwidth="100" maxheight="400" maxwidth="400" class="Lelem" operating="null"><div operating="null" style="display: block; cursor: pointer; position: absolute; top: 0px; left: 4px; z-index: 10003; width: 98px; height: 97px;" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_12.png" style="width: 98px; height: 97px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 105px; left: 10px; z-index: 10004; width: 82px; height: 31px;" operating="KF" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 82px; height: 31px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 139px; left: 10px; z-index: 10005; width: 83px; height: 31px;" operating="KF" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 83px; height: 31px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 208px; left: 10px; z-index: 10006; width: 83px; height: 31px;" operating="QQ|343788668" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 83px; height: 31px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 173px; left: 10px; z-index: 10007; width: 83px; height: 31px;" operating="KF" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_23.png" style="width: 83px; height: 31px;"></div><div style="display: block; cursor: default; position: absolute; top: 113px; left: 18px; z-index: 10008; width: 16px; height: 16px;" type="img" class="Lelem"><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_2.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: default; position: absolute; top: 147px; left: 17px; z-index: 10009; width: 16px; height: 16px;" type="img" class="Lelem" operating=" "><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_2.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: default; position: absolute; top: 180px; left: 17px; z-index: 10010; width: 16px; height: 16px;" type="img" class="Lelem" operating=" "><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_2.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: default; position: absolute; top: 216px; left: 17px; z-index: 10011; width: 16px; height: 16px;" type="img" class="Lelem" operating=" "><img src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_1.png" style="width: 16px; height: 16px;"></div><div style="display: block; cursor: pointer; position: absolute; top: 112px; left: 45px; z-index: 10013; width: 31px; height: 17px;" type="text" class="Lelem" operating="KF"><span style="vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;" iseditable="1">客服1</span></div><div style="display: block; cursor: pointer; position: absolute; top: 146px; left: 45px; z-index: 10014; width: 37px; height: 17px;" type="text" class="Lelem" operating="KF"><span style="vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;" iseditable="1">客服2</span></div><div style="display: block; cursor: pointer; position: absolute; top: 179px; left: 45px; z-index: 10015; width: 41px; height: 17px;" type="text" class="Lelem" operating="KF"><span style="vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;" iseditable="1">客服3</span></div><div style="display: block; cursor: pointer; position: absolute; top: 214px; left: 41px; z-index: 10016; width: 47px; height: 17px;" type="text" class="Lelem" operating="QQ|343788668"><span style="vertical-align: top; font-size: 11.9px; line-height: 17px;" iseditable="1">QQ客服</span></div><div operating="null" class="Lelem" type="img" style="display: block; cursor: pointer; position: absolute; top: 33px; left: 3px; z-index: 10001; width: 97px; height: 217px;"><img style="width: 97px; height: 217px;" src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg/commonbg_11.png"></div></div>','<div id="KFLOGO" style="width: 101px; height: 109px; position: relative; z-index: 10000; cursor: pointer;" minheight="100" minwidth="100" maxheight="400" maxwidth="400" class="Lelem" operating="null"><div class="Lelem" type="img" operating="KF" style="display: block; cursor: pointer; position: absolute; top: 74px; left: 4px; z-index: 10002; width: 93px; height: 28px;"><img style="width: 93px; height: 28px;" src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_66.png"></div><div operating="KF" class="Lelem" type="img" style="display: block; cursor: pointer; position: absolute; top: 0px; left: 1px; z-index: 10002; width: 96px; height: 100px;"><img style="width: 96px; height: 100px;" src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_13.png"></div></div>',kf_icons[this.config["id"]].getClickUrl());
									html += "</div>";
								}
								else
								{
							...
							else
							{
								...
								if ('1')
								{
									var offval_str = '<div id="KFLOGO" style="width: 101px; height: 109px; position: relative; z-index: 10000; cursor: pointer;" minheight="100" minwidth="100" maxheight="400" maxwidth="400" class="Lelem" operating="null"><div class="Lelem" type="img" operating="KF" style="display: block; cursor: pointer; position: absolute; top: 74px; left: 4px; z-index: 10002; width: 93px; height: 28px;"><img style="width: 93px; height: 28px;" src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_66.png"></div><div operating="KF" class="Lelem" type="img" style="display: block; cursor: pointer; position: absolute; top: 0px; left: 1px; z-index: 10002; width: 96px; height: 100px;"><img style="width: 96px; height: 100px;" src="http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_13.png"></div></div>';
		...
		}			if (typeof(kf_icons) == "undefined")
			{
				...
				function _closeIcon()
				{
					...
					if (0 == 1 || 72060470 == 600603 || 72060470 == 61393572 || 72060470 == 1413303 || 72060470 == 61389920 || 72060470 == 61420906 || 72060470 == 61578368)
					{
						if (2 == 1)
						{
			...
			kf_icons[kf_icon_id].config["arg"] = "10060470";
			//kf_icons[kf_icon_id].config["logo_id"]="1087";
			kf_icons[kf_icon_id].config["style_id"] = "&style=5";
			kf_icons[kf_icon_id].config["isonline"] = "1";
	    kf_icons[kf_icon_id].config["zdytb_on_arrs"] = [];
	    kf_icons[kf_icon_id].config["zdytb_off_arrs"] = [];
	    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_on_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,112,116,-,-,1,-,no-repeat,-,-,-,-,12,-,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank#2,\u5728\u7ebf\u56fe\u6807,chat,112,116,0,0,2,http:\/\/www10.53kf.com\/img\/kflogo\/v5_2.gif,no-repeat,-,-,zdy,-,12,000000,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank");
	    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_off_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,112,116,-,-,1,-,no-repeat,-,-,-,-,12,-,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank#2,\u79bb\u7ebf\u56fe\u6807,chat,112,116,0,0,2,http:\/\/www10.53kf.com\/img\/kflogo\/v5_2_off.gif,no-repeat,-,-,zdy,-,12,000000,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank");
			kf_icons[kf_icon_id].config["img_on"] = "http://www10.53kf.com/img/kflogo/v5_2.gif";
			kf_icons[kf_icon_id].config["img_off"] = "http://www10.53kf.com/img/kflogo/v5_2_off.gif";
			...
			kf_icons[kf_icon_id].config["offsetH"] = parseInt("100");
			...
			kf_icons[kf_icon_id].config["kf"] = "&kflist=off&kf=service@avtechcn.cn,office@avtechcn.cn,training@avtechcn.cn,dandanzhu@avtechcn.cn&zdkf_type=1";
			...
			var hz6d_zdyurl = "?arg=10060470&style=5&kflist=off&kf=service@avtechcn.cn,office@avtechcn.cn,training@avtechcn.cn,dandanzhu@avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&lytype=0&referer={hz6d_referer}{hz6d_keyword}&tpl=crystal_blue";
		...
		//document.write("<scr"+"ipt src='http://www10.53kf.com/stat.php?com_id=72060470" + hz6d_referer + hz6d_from_page_new + "' type='text/javascript' id='stat_script'></scr"+"ipt>");
		$53.createScript('stat_script','http://www10.53kf.com/stat.php?com_id=72060470' + hz6d_referer + hz6d_from_page_new);
	}(function() {
	var datas = {
		visit_uuid : '3f75292fe7f0c4ef01803286d446d206',
		company_id : '72060470',
		guest_id : '50443799210',
		site_uid : '11111111',
		in_time : '2015-01-07 12:49:23',
