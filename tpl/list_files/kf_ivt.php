		...
		if(hz6d_get_guest_id_over==0 && hz6d_get_guest_id_num>0){
			...
			if(hz6d_guest_id!="" && hz6d_guest_id>0){
				if(hz6d_cus_web_msg_gids.indexOf(hz6d_guest_id)>=0){
					var url = "http://www10.53kf.com/lword_reply.php?company_id=72060470&guest_id="+hz6d_guest_id;
	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www10.53kf.com/webCompany.php?arg=10060470&style=5&kflist=off&kf=service%40avtechcn.cn%2Coffice%40avtechcn.cn%2Ctraining%40avtechcn.cn%2Cdandanzhu%40avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Foffice.avtechcn.com%2Fexcel%2F&keyword=&brief=&logo=&question=";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"acc_title\" style=\"    position: relative; z-index: 10000; cursor: pointer;\" minheight=\"100\" minwidth=\"100\" maxheight=\"400\" maxwidth=\"400\" class=\"Lelem\" operating=\"null\"><div style=\"display: block; cursor: pointer; position: absolute; top: 13px; left: 7px; z-index: 10002; width: 418px; height: 173px;\" type=\"img\" class=\"Lelem\" operating=\"null\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_8.png\" style=\"width: 418px; height: 173px;\"></div><div style=\"display: block; cursor: pointer; position: absolute; top: 21px; left: 21px; z-index: 10002; width: 187px; height: 22px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-size: 15.4px; line-height: 22px; color: rgb(255, 255, 255); font-weight: bold; font-family: 黑体;\" iseditable=\"1\">AVTECH Training Center</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 21px; left: 394px; z-index: 10003; width: 18px; height: 18px;\" operating=\"CLOSE\" type=\"img\" class=\"Lelem\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_0.png\" style=\"width: 18px; height: 18px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 61px; left: 35px; z-index: 10004; width: 78px; height: 105px;\" type=\"img\" class=\"Lelem\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_15.png\" style=\"width: 78px; height: 105px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 62px; left: 150px; z-index: 10005; width: 144px; height: 23px; color: rgb(0, 0, 0);\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-weight: bold; color: rgb(0, 0, 0); font-family: 黑体; font-size: 16.1px; line-height: 23px;\" iseditable=\"1\">欢迎咨询！</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 90px; left: 150px; z-index: 10006; width: 202px; height: 17px;\" type=\"text\" class=\"Lelem\" operating=\"null\"><span style=\"vertical-align:top;\" iseditable=\"1\">艾威培训，感谢大家的支持！</span></div><div style=\"display: block; cursor: default; position: absolute; top: 112px; left: 150px; z-index: 10007; width: 171px; height: 17px;\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-size: 12px; line-height: 17px;\" iseditable=\"1\">请问有什么可以帮您？</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 137px; left: 150px; z-index: 10008; width: 97px; height: 34px;\" operating=\"KF\" type=\"img\" class=\"Lelem\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_22.png\" style=\"width: 97px; height: 34px;\"></div><div style=\"display: block; cursor: pointer; position: absolute; top: 144px; left: 270px; z-index: 10009; width: 60px; height: 17px; color: rgb(0, 51, 204);\" type=\"text\" class=\"Lelem\" operating=\"CLOSE\"><span style=\"vertical-align: top; color: rgb(0, 51, 204); font-family: 宋体; font-size: 12px; line-height: 17px; text-decoration: underline;\" iseditable=\"1\">下次再说</span></div></div>";
			var is_autoyqk				= "1";
			...
			{
				var openurl = "http://www10.53kf.com/webCompany.php?arg=10060470&style=5&kflist=off&kf=service%40avtechcn.cn%2Coffice%40avtechcn.cn%2Ctraining%40avtechcn.cn%2Cdandanzhu%40avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Foffice.avtechcn.com%2Fexcel%2F&keyword=&brief=&logo=&question=&tfrom=2"+force_kf;
				try{
			...
			function hz6d_overTotalNum(){
				...
				if(acc_pop_total==1){
					var total_invite = $53.getCookie("invite_53kf_totalnum_5");
			...
			function hz6d_setTotalNum()
			{
				...
				if(total_invite=="") { total_invite = 0; }
				total_invite++;
				document.cookie = "invite_53kf_totalnum_5="+total_invite;
			}
			...
			function hidden_ivt()
			{
				if(acc_autotype==3) { document.cookie = "onliner_zdfq72060470="+onliner_zdfq; }
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF': 
								case 'KF': var click_open_url = 'window.open(\"http://www10.53kf.com/webCompany.php?arg=10060470&style=5&kflist=off&kf=service%40avtechcn.cn%2Coffice%40avtechcn.cn%2Ctraining%40avtechcn.cn%2Cdandanzhu%40avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Foffice.avtechcn.com%2Fexcel%2F&keyword=&brief=&logo=&question=&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								click_open_url = encodeURIComponent(click_open_url);
								click_str ='onliner_zdfq=2;hz6d_is_exist(\"'+click_open_url+'\");hidden_ivt();';break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www10.53kf.com/webCompany.php?arg=10060470&style=5&kflist=off&kf=service%40avtechcn.cn%2Coffice%40avtechcn.cn%2Ctraining%40avtechcn.cn%2Cdandanzhu%40avtechcn.cn&zdkf_type=1&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Foffice.avtechcn.com%2Fexcel%2F&keyword=&brief=&logo=&question=&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
